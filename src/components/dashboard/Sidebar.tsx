...
interface SidebarProps {
  ...
  onCategorySelect: (categoryId: string, hasChildren?: boolean) => void;
}
    ...
    >
      <button
        onClick={() => {
          ...
          onCategorySelect(category.id, hasChildren);
        }}
        className={cn(
...
export function Sidebar({
  ...
  return (
    <aside className="w-64 h-[100dvh] fixed left-0 top-0 glass-panel border-r border-border/30 flex flex-col safe-top safe-bottom">
      {/* Logo */}
