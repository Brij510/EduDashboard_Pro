        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-xl border border-border/50 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Download the current content as <code>folder-structure.json</code> and replace <code>public/folder-structure.json</code> before committing.
            </p>
            <button 
          ...
          <div className="p-4 rounded-xl border border-primary/30 bg-primary/5">
            ...
            <p className="text-xs text-muted-foreground">
              Visitors and developers both load content from committed <code>public/folder-structure.json</code>.
            </p>
          </div>
        </div>
      )}
